...
export const LOAD_STUDENTTESTCOMMENT_REQUEST = 'LOAD_STUDENTTESTCOMMENT_REQUEST'
export const LOAD_STUDENTTESTCOMMENT_SUCCESS = 'LOAD_STUDENTTESTCOMMENT_SUCCESS'
export const LOAD_STUDENTTESTCOMMENT_FAILURE = 'LOAD_STUDENTTESTCOMMENT_FAILURE'
...
export const getOwnStudentTest = (studentTestId) => (dispatch) => {
  dispatch({ type: LOAD_STUDENTTESTCOMMENT_REQUEST })
  return axios.get(`/api/v1/assessments/studentTest/${studentTestId}`)
  .then(res => dispatch({ type: LOAD_STUDENTTESTCOMMENT_SUCCESS, studentTest: res.data }))
  .catch(err => dispatch({ type: LOAD_STUDENTTESTCOMMENT_FAILURE, err }))
